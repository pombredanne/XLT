 ...
 *
 * <p> This version does not use a lock and also uses StringBuilder instead of
 * StringBuffer for sake of speed.
 *
 * @see FileReader
...
public class NonStringBufferedReader extends Reader 
{
    ...
    private static int defaultExpectedLineLength = 4 * 80;
    /**
     ...
     */
    public NonStringBufferedReader(Reader in, int sz) {
        super(in);
        if (sz <= 0)
    ...
    public String readLine() throws IOException {
        final OpenStringBuilder b = readLine(false);
        return b != null ? b.toString() : null;
    }

    public OpenStringBuilder readLineAsStringBuffer() throws IOException {
